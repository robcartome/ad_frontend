          ...
          <header className="sticky top-0 z-50 bg-white shadow-lg border-b border-blue-100">
            <nav className="container mx-auto px-4 sm:px-0 sm:py-2 flex justify-between items-center">
              ...
              <div className="flex items-center space-x-4 sm:space-x-6">
                ...
                <Link
                  href="/cart"
                  className={`p-2 rounded-full text-gray-700 hover:bg-gray-100 transition-colors hover:${secondaryColor}`}
                >
                ...
                <Link
                  href="/login"
                  className={`p-2 rounded-full text-gray-700 hover:bg-gray-100 transition-colors hover:${primaryColor}`}
                >
          ...
          <footer className="bg-gray-800 py-6 text-center text-white">
            <div className="container mx-auto px-4">
              ...
              <div className="mt-2 pt-2 border-t border-gray-700">
                ...
                <Link
                  href="https://apudig.com"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xs font-light text-blue-400 hover:text-blue-300 transition-colors"
                >
